...
@Component({
  selector: 'app-connections-received',
  templateUrl: './connections-received.component.html',
  styleUrls: ['./connections-received.component.scss']
})
export class ConnectionsReceivedComponent implements OnInit, OnDestroy {
